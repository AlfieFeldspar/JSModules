...
//alternate export syntax if modules are prepended with MessageMixer:
//export default MessageMixer;  //use with import MessageMixer from...
//module.exports = MessageMixer;  // use with const MessageMixer...